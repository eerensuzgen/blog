      ...
      <div className="about">
        ...
        <div className="aboutBioBlock">
          ...
          <p className="aboutBioText">
            ...
            olduğunu göz önüne alarak yalnızca iletişim alanında değil Siyaset,
            İktisat, Sosyoloji, Edebiyat, Felsefe ve Tarih başta olmak üzere
            birçok sosyal bilim hakkında bilgi sahibi olmaya çabalıyorum.
            Bilginin tartışmaya, tartışmanın bilgiye evirildiği düşüncesinde
            biri olarak sahip olmaya çabaladığım bilgilerin ışığında yazdığım
            her türlü yazıyı paylaşacağım kuskulu.com ile yeni bilgilere kapı
            aralamayı amaçlıyorum. Bu amacı göz önünde bulundurarak belleğin
            bulanıklığı ile saydamlığı ilkelerinin birbirine bağımlılığı
            tarihsel süreç içerisinde kanıtlanan ve bu nedenle son sözünü daha
            söylemeyen kuşkunun aydınlığında yaşamı görünür kılmak adına kuşkuya
            bağlılığımı dile getirmek için “Kuşkulu” adını benimsiyorum.
            Böylelikle “kuşkunun kuşkusuzluğuyla kuşkulu günlere…” ilkesini bir
            dilek olarak değil amaç olarak nitelendiriyorum. Kuşkuyla
            haykırıyorum ve herkesi dillerden düşmeyen, en önemlisi belleklerden
            silinmeyecek bir biçimde haykırmaya çağırıyorum: Kuşkunun
            kuşkusuzluğuyla kuşkulu günlere…
          </p>
        </div>
        <br />
        <div>
